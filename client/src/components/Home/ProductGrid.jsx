...
function ProductGrid() {
  ...
  const products = [
    ...
    },
    {
      ...
      price: 399,
      oldPrice: 799,
      title: 'Elegant Product 5',
    },
    {
      image: '/images/pendant3.jpeg',
      rating: 4.9,
      reviews: '500 reviews',
      price: 1199,
      oldPrice: 1999,
      title: 'Top-notch Product 6',
    },
    {
    ...
    },
    {
      ...
      price: 1299,
      oldPrice: 2199,
      title: 'Limited Edition Product 12',
    },
  ];

  return (
    <div className="p-6">
          <h2 className=" text-center text-3xl md:text-4xl font-serif mb-4">Buy Premium</h2>
      ...
      {visibleCount < products.length && (
        <div className="flex justify-center mt-8">
          <button
            ...
            className="px-6 py-2 bg-gradient-to-r from-pink-400 to-yellow-400 text-white font-bold rounded-full hover:from-pink-500 hover:to-yellow-500 transition-all duration-300"
          >
            Load More
          </button>
        </div>
